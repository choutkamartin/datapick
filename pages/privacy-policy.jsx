...
function PrivacyPolicy() {
  return (
    <div className="flex flex-col gap-y-36 py-8 lg:py-24">
      <Container variant="box" className="flex-col">
        <Heading headingLevel="h1">Privacy Policy</Heading>
        <p>
          Last updated: January 19, 2022 This Privacy Policy describes Our
        ...
        <Heading headingLevel="h2">Interpretation and Definitions</Heading>
        <Heading headingLevel="h3">Interpretation</Heading>
        ...
        <List>
          ...
          <List.Item>
            ...
            this Agreement) refers to Datapick.
          </List.Item>
          <List.Item>
        ...
        <List>
          <List.Item>By email: email@martinchoutka.cz</List.Item>
        </List>
      </Container>
    </div>
  );
